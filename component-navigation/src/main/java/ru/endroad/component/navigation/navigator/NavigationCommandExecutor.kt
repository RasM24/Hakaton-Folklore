...
import ru.endroad.component.navigation.manager.changeRoot
import ru.endroad.component.navigation.manager.defaultForwardAnimation
import ru.endroad.component.navigation.manager.defaultReplaceAnimation
import ru.endroad.component.navigation.manager.forwardTo
import ru.endroad.component.navigation.manager.replace
...
class NavigationCommandExecutor {
	...
	private fun open(destination: Destination, context: Context, fragmentManager: FragmentManager, container: Int) {
		when (destination) {
			is DialogFragmentDestination -> destination.createFragment().show(fragmentManager, "dialog")
